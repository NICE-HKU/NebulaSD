# Vendored SwiftLLM for NebulaSD

This is a modified backend. For NebulaSD installation and execution, use the [repository README](../README.md). See [integration notes](docs/NEBULASD_INTEGRATION.md) and [third-party notices](../THIRD_PARTY_NOTICES.md). The upstream documentation below is retained for background; its performance claims are not NebulaSD results.
